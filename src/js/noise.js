// Perlin/Simplex noise (public domain) adapted for ES modules.
// Source: Stefan Gustavson, Peter Eastman, Joseph Gentle (2012-03-09).
const moduleNoise = {};
...
const p = [151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23,
  ...
  19,98,108,110,79,113,224,232,178,185,112,104,218,246,97,228,251,34,242,193,238,210,144,12,191,179,162,241,
...
moduleNoise.seed = function (seed) {
...
moduleNoise.simplex2 = function (xin, yin) {
  let n0, n1, n2;
  const s = (xin + yin) * F2;
...
moduleNoise.simplex3 = function (xin, yin, zin) {
  let n0, n1, n2, n3;
...
moduleNoise.perlin2 = function (x, y) {
...
moduleNoise.perlin3 = function (x, y, z) {
